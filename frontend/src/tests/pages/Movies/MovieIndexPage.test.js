...
describe("MovieIndexPage tests", () => {
    ...
    test("renders correct fields", () => {
        ...
        const title = screen.getByText("Monsters, Inc.");
        expect(title).toBeInTheDocument();

        const rating = screen.getByText(8.1);
        expect(rating).toBeInTheDocument();

        const views = screen.getByText(2000000);
    ...
    test("delete button calls delete and reloads page", async () => {
        ...
        const expectedMessage = `MovieIndexPage deleteCallback: {"id":3,"title":"Monsters, Inc.","rating":8.1,"views":2000000}`;
